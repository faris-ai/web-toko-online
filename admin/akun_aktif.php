...
<div class="shadow p-3 bg-white rounded">
    <h1 class="m-4">Akun Aktif <span><h3 class="pull-right"><?=count($akuns);?> Akun</h3></span></h1>
                    ...
                    <table class="table table-striped table-bordered" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-danger" href="akun_action.php?blokir=<?=$id_user;?>" role="button"data-toggle="tooltip" data-placement="top" title="Blokir Akun" onclick="return confirm('Apakah anda yakin ingin memblokir akun ini?')"><i style='font-size:16px' class="fa fa-ban fa-3x"></i></a>
                                </td>
                            </tr>
                            <?php
                            $i++;
